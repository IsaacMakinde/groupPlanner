...
const Introduction: React.FC = () => {
  return (
    <div className=" is-flex has-background-white is-flex-direction-column section is-align-items-center">
      <div className="is-flex is-flex-direction-column is-align-items-center">
        ...
        <h1 className="title has-text-grey is-align-self-cent">
          Hello, I'm Isaac Makinde👋
        </h1>
      </div>
      <h1 className="impact-headline">Fullstack{"\n"}Developer.</h1>
